    ...
    public class Code128 : BarCode
    {
        ...
        private void RenderText(BarCodeRenderInfo info)
        {
            ...
            else if (this.TextLocation == TextLocation.AboveEmbedded)
            {
                ...
                info.Gfx.DrawString(Text, info.Font, info.Brush, new XRect(center, this.Size), XStringFormats.TopCenter);
            }
            else if (this.TextLocation == TextLocation.Below)
                info.Gfx.DrawString(Text, info.Font, info.Brush, new XRect(center, this.Size), XStringFormats.BottomCenter);
        ...
        protected internal override void Render(XGraphics gfx, XBrush brush, XFont font, XPoint position)
        {
            ...
            this.Values = this.Code128Code == Code128Type.C ? new byte[Text.Length / 2] : new byte[Text.Length];
